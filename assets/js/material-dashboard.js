...
md = {
  ...
  initDashboardPageCharts: function() {
    ...
    if ($('#dailySalesChart').length != 0 || $('#dailySalesChart1').length != 0 ||  $('#completedTasksChart').length != 0 || $('#completedTasksChart1').length != 0 || $('#completedTasksChart2').length != 0 ||  $('#websiteViewsChart').length != 0) {
      ...
      dataDailySalesChart1 = {
        labels: ['Tecnologia', 'Operacional', 'Vendas', 'Financeiro'],
        series: [
          [12, 17, 7, 38]
        ]
      };
      ...
      dataCompletedTasksChart2 = {
        labels: ['Covid', 'Ortopedia', 'Cardiologia', 'US', 'TC'],
        series: [
          [30, 10, 15, 50, 60]
        ]
      };
      ...
      /* ----------==========     Adesão de Colaboradores    ==========---------- */

      dataCompletedTasksChart = {
        labels: ['12', '3', '6', '9', '12', '6', '6', '6'],
        series: [
          [230, 750, 450, 300, 280, 240, 220, 210]
        ]
      };
